...
//  EasyAnchors
//
//  Created by Dante Solorio on 1/30/18.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        redView.anchor(top: view.safeAreaLayoutGuide.topAnchor, leading: nil, bottom: nil, trailing: view.safeAreaLayoutGuide.trailingAnchor, padding: .init(top: 0, left: 0, bottom: 0, right: 12), size: CGSize(width: 125, height: 0))
